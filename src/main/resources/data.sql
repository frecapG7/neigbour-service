...
INSERT INTO POINT_OF_INTEREST (ID, NAME, ADDRESS, URI, PHONE, CATEGORY, DISTRICT_ID) VALUES('3', 'Street Monkeys', '3625 Rue Wellington', '(514)768-1818', 'streetmonkeys.ca' , 'R', (SELECT id FROM DISTRICT WHERE ID = '1') );